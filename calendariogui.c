...
int main(void){
    ...
    printf("Informe o 1º dia da semana de janeiro do ano atual! Digite 1 para Domingo, 2 para Segunda, 3 para Terça: \n");
    scanf("%d", &diaSemana);
    printf(" Digite 's' se o ano atual for bissexto  ou 'n' se não: ");
    scanf(" %c", &anoBi);
